...
SRC_URI="
		https://github.com/patrickjaja/claude-desktop-bin/releases/download/v${MY_PV}-${MY_PR}/${MY_PN}-${MY_PV}-linux.tar.gz -> ${MY_PN}-${MY_PV}-${MY_PR}-linux.tar.gz
...
src_unpack() {
	unpack ${MY_PN}-${MY_PV}-${MY_PR}-linux.tar.gz
