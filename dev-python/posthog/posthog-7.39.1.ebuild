...
# six and python-dateutil were dropped from the core deps after 7.29;
# dateutil is now test-only.
RDEPEND="
...
# mcp tests need dev-python/{mcp,fastmcp} which are not in ::gentoo
EPYTEST_IGNORE=(
	posthog/test/ai/
	posthog/test/mcp/
)
